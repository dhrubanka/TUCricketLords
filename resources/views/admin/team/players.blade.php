...
<div class="container" style="margin-top: 2em">
    <div class="row" >
        ...
        <div class="col-5 col-sm-4 text-right">
            <a href="/admin/player/{{$team->id}}/create"><button type="button" class="btn btn-primary m-1">
             Create players under : {{$team->team_name}}</button></a>
        </div>
    </div>
        ...
        @foreach( $players as $player )
            <div class="col-sm-3">
                ...
                <div class="card-body">
                    ...
                    <a href="/admin/team/{{ $player->id }}/edit" class="btn btn-primary m-1">View|Edit</a>
                    <a href="/admin/players/{{ $player->id }}" class="btn m-1 btn-primary">Players </a>
